class CloudUser < Cloud::Sdk::UserModel
  attr_accessor :rhlogin, :uuid, :system_ssh_keys, :env_vars, :ssh_keys, :ssh, :ssh_type, :namespace, :key, :type, :max_gears, :consumed_gears
  primary_key :rhlogin
  ...
  def initialize(rhlogin=nil, ssh=nil, namespace=nil, ssh_type='ssh-rsa')
    ...
    self.max_gears = 5
    self.consumed_gears = Rails.application.config.cdk[:default_max_gears]
  end
