...
Gem::Specification.new do |s|
  s.name        = "cloud-sdk-engine"
  s.version     = /(Version: )(.*)/.match(File.read("cloud-sdk-engine.spec"))[2]
  s.authors     = ["Krishna Raman"]
  s.email       = ["kraman@gmail.com"]
  s.homepage    = "http://www.openshift.com"
  s.summary     = %q{Cloud Development Engine}
  s.description = %q{Cloud Development Engine}

  s.rubyforge_project = "cloud-sdk-engine"
  s.files       = Dir[lib_dir] + Dir[bin_dir] + Dir[conf_dir] + Dir[test_dir]
  s.files       += %w(README.md Rakefile Gemfile cloud-sdk-engine.spec cloud-sdk-engine.gemspec)
