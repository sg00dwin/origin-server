...
class ApplicationTest < ActiveSupport::TestCase
  ...
  test "create_dns" do
    ...
    application.expects(:container).returns(Cloud::Sdk::ApplicationContainerProxy.instance("asldksd"))
    Cloud::Sdk::ApplicationContainerProxy.any_instance.stubs(:get_public_hostname).returns("foo.bar")
