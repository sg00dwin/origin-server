...
<?php
$no_display = array('Display Name', 'First Name', 'Last Name');
if (!in_array($title, $no_display)) { ?>
  <div class="profile-data-title"><?php print check_plain($title); ?></div>
  <div class="profile-data-content"><?php print check_plain($value); ?></div><?php
}
?>