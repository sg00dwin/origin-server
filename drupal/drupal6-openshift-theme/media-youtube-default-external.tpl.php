...
<div id="media-youtube-default-external-<?php print $id; ?>">
  <object type="application/x-shockwave-flash" height="<?php print $height; ?>" width="<?php print $width; ?>" data="<?php print str_replace('http:','https:',$url); ?>" id="media-youtube-default-external-object-<?php print $id; ?>">
    <param name="movie" value="<?php print str_replace('http:','https:',$url); ?>" />
    ...
    <!-- Fallback content -->
      <?php print str_replace('http:','https:',$thumbnail); ?>
  </object>
</div>
