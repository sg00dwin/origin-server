...
<html class='no-js' lang='en'>
  ...
  <body class='community'>
    <header>
      <div id="top" class="section-top">
        <div class="container">
          ...
          <div class="mobile-block"><a href="/community/enterprise-paas"><span>Streamline App Delivery with  </span>OpenShift Enterprise</a></div>
        </div>
      </div>
    ...
    <div id="oTags">
    <script type="text/javascript" src="/app/assets/site/tracking.js"></script>
    <script type="text/javascript" src="/app/assets/site/s_code.js"></script>
