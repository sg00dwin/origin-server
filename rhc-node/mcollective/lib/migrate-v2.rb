...
require File.dirname(__FILE__) + "/migrate-v2-diy-0.1"
require File.dirname(__FILE__) + "/migrate-v2-jbossas-7"
require File.dirname(__FILE__) + "/migrate-v2-jbosseap-6.0"
require File.dirname(__FILE__) + "/migrate-v2-jbossews-1.0"
require File.dirname(__FILE__) + "/migrate-v2-jbossews-2.0"
require File.dirname(__FILE__) + "/migrate-v2-nodejs-0.6"
require File.dirname(__FILE__) + "/migrate-v2-perl-5.10"
require File.dirname(__FILE__) + "/migrate-v2-php-5.3"
require File.dirname(__FILE__) + "/migrate-v2-python-2.6"
require File.dirname(__FILE__) + "/migrate-v2-ruby-1.8"
require File.dirname(__FILE__) + "/migrate-v2-ruby-1.9"
require File.dirname(__FILE__) + "/migrate-v2-zend-5.6"
require File.dirname(__FILE__) + "/migrate-v2-metrics-0.1"
require File.dirname(__FILE__) + "/migrate-v2-jenkins-1.4"
require File.dirname(__FILE__) + "/migrate-v2-jenkins-client-1.4"
require File.dirname(__FILE__) + "/migrate-v2-mongodb-2.2"
require File.dirname(__FILE__) + "/migrate-v2-rockmongo-1.1"
require File.dirname(__FILE__) + "/migrate-v2-10gen-mms-agent-0.1"
require File.dirname(__FILE__) + "/migrate-v2-mysql-5.1"
require File.dirname(__FILE__) + "/migrate-v2-phpmyadmin-3.4"
require File.dirname(__FILE__) + "/migrate-v2-postgresql-8.4"
