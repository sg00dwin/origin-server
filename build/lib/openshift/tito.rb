...
SIBLING_REPOS = {'crankcase' => ['../crankcase-working', '../crankcase-fork', '../crankcase', './crankcase', '/var/lib/jenkins/jobs/crankcase/workspace'],
                 'rhc' => ['../rhc-working', '../rhc-fork', '../rhc', './rhc', '/var/lib/jenkins/jobs/rhc/workspace']}
