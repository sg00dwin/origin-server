module OpenShift
  module Brew
    ...
    # 
    # source  - The source brew tag to lookup (example: libra-rhel-6.4-candidate)
    # target  - The target brew tag to lookup (example: libra-rhel-6.4-stage)
    ...
    #
    # Examples:
    #   get_packages_to_tag("libra-rhel-6.4-candidate", "libra-rhel-6.4-stage", "2012-04-15")
