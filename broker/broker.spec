...
%{brokerdir}
%{htmldir}/broker
%attr(0500,-,-) %{_bindir}/rhc-admin-ctl-domain
%attr(0500,-,-) %{_bindir}/rhc-admin-ctl-app
%attr(0500,-,-) %{_bindir}/rhc-admin-cartridge-do
%attr(0500,-,-) %{_bindir}/rhc-admin-deconfigure-on-node
%attr(0500,-,-) %{_bindir}/rhc-admin-move
