...
"
    ...
    if application.user.auth_method == :login and application.user.vip == false and not (application.node_profile.nil? or ["std","small"].include?(application.node_profile))
