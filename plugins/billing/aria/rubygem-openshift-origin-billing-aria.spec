...
- Fix consistency check in aria plugin (rpenta@redhat.com)

* Fri Sep 06 2013 Adam Miller <admiller@redhat.com> 1.12.2-1
- Fix broker extended tests (billing test) (rpenta@redhat.com)
