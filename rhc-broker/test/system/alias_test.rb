...
-----END CERTIFICATE-----"
    ...
    request_via_redirect(:post, APP_ALIAS_COLLECTION_URL_FORMAT % [ns, app], {:alias => "@XYZ%^&!"}, @headers)
    assert_response :unprocessable_entity
    body = JSON.parse(@response.body)
    assert_equal(body["messages"][0]["exit_code"], 105)
    
    request_via_redirect(:post, APP_ALIAS_COLLECTION_URL_FORMAT % [ns, app], {:alias => ""}, @headers)
    assert_response :unprocessable_entity
    body = JSON.parse(@response.body)
    assert_equal(body["messages"][0]["exit_code"], 105)
    
    #try adding certificate without private key
    request_via_redirect(:post, APP_ALIAS_COLLECTION_URL_FORMAT % [ns, app], {:alias => as, :ssl_certificate => ssl_certificate}, @headers)
    assert_response :unprocessable_entity
    body = JSON.parse(@response.body)
    ...
    request_via_redirect(:post, APP_ALIAS_COLLECTION_URL_FORMAT % [ns, app], {:alias => as, :ssl_certificate => ssl_certificate, :private_key => "ABCD"}, @headers)
    assert_response :unprocessable_entity
    body = JSON.parse(@response.body)
    assert_equal(body["messages"][0]["exit_code"], 172)  
    assert_equal(body["messages"][0]["field"], "private_key")
    ...
    request_via_redirect(:post, APP_ALIAS_COLLECTION_URL_FORMAT % [ns, app], {:alias => as, :ssl_certificate => ssl_certificate, :private_key => wrong_private_key, :pass_phrase => pass_phrase}, @headers)
    assert_response :unprocessable_entity
    body = JSON.parse(@response.body)
    assert_equal(body["messages"][0]["exit_code"], 172)  
    assert_equal(body["messages"][0]["field"], "private_key")
    ...
    request_via_redirect(:post, APP_ALIAS_COLLECTION_URL_FORMAT % [ns, app], {:alias => as, :ssl_certificate => "ABCDEF", :private_key => private_key, :pass_phrase => pass_phrase}, @headers)
    assert_response :unprocessable_entity
    body = JSON.parse(@response.body)
    ...
    request_via_redirect(:post, APP_ALIAS_COLLECTION_URL_FORMAT % [ns, app], {:alias => as}, @headers)
    assert_response :created
    body = JSON.parse(@response.body)
    ...
    request_via_redirect(:post, APP_ALIAS_COLLECTION_URL_FORMAT % [ns, app], {:alias => as, :ssl_certificate => ssl_certificate, :private_key => private_key, :pass_phrase => pass_phrase}, @headers)
    assert_response :created
    body = JSON.parse(@response.body)
    assert_equal(body["data"]["id"], as)
    assert_equal(body["data"]["has_private_certificate"], true) 
