...
%changelog
* Thu Jan 24 2013 Adam Miller <admiller@redhat.com> 1.3.11-1
- bump site.spec for chain build (admiller@redhat.com)

* Thu Jan 24 2013 Adam Miller <admiller@redhat.com> - 1.3.10-2
- bump for chain build
