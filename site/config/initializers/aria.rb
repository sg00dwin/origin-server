Rails.application.config.tap do |config|
  ...
  config.aria_show_unrated_unbilled_usage = Console.config.env(:ARIA_SHOW_UNRATED_UNBILLED_USAGE, false)
  ...
  config.vies_countries    = Console.config.env(:ARIA_VIES_COUNTRIES,    [:AT, :BE,           :DE, :DK, :ES, :FI, :FR, :GB, :IE,      :IT, :LU, :NL,      :PT, :SE])
  ...
  # VAT config
  # Specify Aria-centric tax "exemption level"; 0 = non-exempt, 3 = fully exempt
  config.tax_level_non_exempt = Console.config.env(:ARIA_TAX_LEVEL_NON_EXEMPT, '0')
  config.tax_level_fully_exempt = Console.config.env(:ARIA_TAX_LEVEL_FULLY_EXEMPT, '3')
