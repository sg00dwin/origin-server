...
alternatives --install /etc/alternatives/jbossas-7.0 jbossas-7.0 /opt/jboss-as-7.1.0.CR1b 102
alternatives --set jbossas-7.0 /opt/jboss-as-7.1.0.CR1b
#
