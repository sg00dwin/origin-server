...
- added standalone-ha.xml (wdecoste@localhost.localdomain)

* Wed Jan 04 2012 Dan McPherson <dmcphers@redhat.com> 0.84.4-1
- initial checkin for US1614 -- jboss remote debugging ports. (ramr@redhat.com)

* Mon Dec 26 2011 Dan McPherson <dmcphers@redhat.com> 0.84.3-1
- Bug 770085 (dmcphers@redhat.com)

* Fri Dec 23 2011 Dan McPherson <dmcphers@redhat.com> 0.84.2-1
- Bug 770085 (dmcphers@redhat.com)
...
- US1550: disable CONSOLE logging (wdecoste@localhost.localdomain)
- use JDK 1.6 (wdecoste@localhost.localdomain)
...
* Mon Nov 28 2011 Dan McPherson <dmcphers@redhat.com> 0.82.8-1
- move start dbs to deploy (dmcphers@redhat.com)

* Wed Nov 23 2011 Dan McPherson <dmcphers@redhat.com> 0.82.7-1
- part 2 of bug 756425 (dmcphers@redhat.com)
- part 1 of bug 756425 (dmcphers@redhat.com)
...
- add force_clean_build to jboss (dmcphers@redhat.com)
...
- Bug 753153 (dmcphers@redhat.com)
- Bug 753153 (dmcphers@redhat.com)

* Thu Nov 10 2011 Dan McPherson <dmcphers@redhat.com> 0.82.1-1
- bump spec numbers (dmcphers@redhat.com)

* Wed Nov 09 2011 Dan McPherson <dmcphers@redhat.com> 0.81.18-1
- update web.xml to 3.0 (dmcphers@redhat.com)

* Tue Nov 08 2011 Alex Boone <aboone@redhat.com> 0.81.17-1
- uncomment jboss dep from pom.xml (dmcphers@redhat.com)

* Tue Nov 08 2011 Troy Dawson <tdawson@redhat.com> 0.81.16-1
- Changed mirrorOf to central (tdawson@redhat.com)

* Tue Nov 08 2011 Dan McPherson <dmcphers@redhat.com> 0.81.15-1
- move maven build size to build.sh env var (dmcphers@redhat.com)

* Sun Nov 06 2011 Dan McPherson <dmcphers@redhat.com> 0.81.14-1
- snapshot tests plus trying to make cuc tests more stable
  (dmcphers@redhat.com)

* Sun Nov 06 2011 Dan McPherson <dmcphers@redhat.com> 0.81.13-1
- work around cucumber failures (dmcphers@redhat.com)
...
* Fri Nov 04 2011 Troy Dawson <tdawson@redhat.com> 0.81.9-1
- dev machines now mirror to the stg mirror (tdawson@redhat.com)

* Fri Nov 04 2011 Troy Dawson <tdawson@redhat.com> 0.81.8-1
- adding local mirror support to jenkins_job_template (tdawson@redhat.com)

* Thu Nov 03 2011 Dan McPherson <dmcphers@redhat.com> 0.81.7-1
- move updates, add pre_build (dmcphers@redhat.com)

* Thu Nov 03 2011 Dan McPherson <dmcphers@redhat.com> 0.81.6-1
...
- fix jenkins errors (dmcphers@redhat.com)
...
* Tue Oct 25 2011 Dan McPherson <dmcphers@redhat.com> 0.80.19-1
- doc updates (dmcphers@redhat.com)

* Tue Oct 25 2011 Dan McPherson <dmcphers@redhat.com> 0.80.18-1
...
* Thu Oct 20 2011 Dan McPherson <dmcphers@redhat.com> 0.80.13-1
