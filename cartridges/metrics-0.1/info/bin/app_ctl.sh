...
metrics_dir=$OPENSHIFT_HOMEDIR/metrics-0.1

export PHPRC="${metrics_dir}/conf/php.ini"
...
HTTPD_PID_FILE=${metrics_dir}/run/httpd.pid
...
case "$1" in
    start)
        ...
        then
            ...
            /usr/sbin/httpd -C "Include ${metrics_dir}/conf.d/*.conf" -f $HTTPD_CFG_FILE -k $1
