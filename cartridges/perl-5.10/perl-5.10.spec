...
%changelog
* Thu Jan 05 2012 Dan McPherson <dmcphers@redhat.com> 0.15.2-1
- mysql and mongo move (dmcphers@redhat.com)

* Wed Dec 14 2011 Dan McPherson <dmcphers@redhat.com> 0.15.1-1
- bump spec numbers (dmcphers@redhat.com)

* Wed Dec 14 2011 Dan McPherson <dmcphers@redhat.com> 0.14.2-1
- 

* Thu Dec 01 2011 Dan McPherson <dmcphers@redhat.com> 0.14.1-1
- bump spec numbers (dmcphers@redhat.com)

* Fri Nov 18 2011 Dan McPherson <dmcphers@redhat.com> 0.13.5-1
...
* Thu Nov 03 2011 Dan McPherson <dmcphers@redhat.com> 0.12.5-1
- move updates, add pre_build (dmcphers@redhat.com)

* Thu Nov 03 2011 Dan McPherson <dmcphers@redhat.com> 0.12.4-1
- abstract move into each cart and embedded cart (dmcphers@redhat.com)

* Wed Nov 02 2011 Dan McPherson <dmcphers@redhat.com> 0.12.3-1
- Allowing alias add / remove (mmcgrath@redhat.com)

* Mon Oct 31 2011 Troy Dawson <tdawson@redhat.com> 0.12.2-1
- adding local mirror capability (tdawson@redhat.com)
