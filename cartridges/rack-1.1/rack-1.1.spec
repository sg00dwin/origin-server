...
- move logic to deploy from post_deploy (dmcphers@redhat.com)
- fixed OpenShift ruby mirror URL (tdawson@redhat.com)
- added ruby mirror documentation (tdawson@redhat.com)

* Sun Nov 27 2011 Dan McPherson <dmcphers@redhat.com> 0.82.6-1
- add :git reference in Gemfile (dmcphers@redhat.com)
...
- Added some deps (mmcgrath@redhat.com)
...
* Tue Oct 25 2011 Dan McPherson <dmcphers@redhat.com> 0.80.15-1
- doc updates (dmcphers@redhat.com)

* Tue Oct 25 2011 Dan McPherson <dmcphers@redhat.com> 0.80.14-1
