%global cartridgedir %{_libexecdir}/openshift/cartridges/v2embedded/rockmongo
%global frameworkdir %{_libexecdir}/openshift/cartridges/v2/rockmongo
...
%attr(0750,-,-) %{cartridgedir}/html/
%attr(0755,-,-) %{frameworkdir}
%config(noreplace) %{cartridgedir}/etc/
%attr(0755,-,-) %{cartridgedir}/bin/
 %{cartridgedir}/rockmongo/
