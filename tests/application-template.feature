...
Feature: Application template list
  ...
  Scenario: Add a template and create an application
    ...
    When I create a new application named 'fooapp' within domain 'cucumber' with the template
    Then the response should be "201"
    When I send a GET request to "/domains/cucumber/applications/fooapp"
    Then the response should be "200"
    When I send a DELETE request to "/domains/cucumber/applications/fooapp"
