...
Feature: applications
  ...
  Scenario: Add and remove application alias
    Given a new guest account
    And I am a valid user
    And I accept "XML"
    When I send a POST request to "/domains" with the following:"namespace=cucumber"
    ...
    When I send a POST request to "/domains/cucumber/applications" with the following:"name=app&cartridge=php-5.3"
    Then the response should be "201"
    When I send a POST request to "/domains/cucumber/applications/app/events" with the following:"event=add-alias"
    Then the response should be "422"
    When I send a POST request to "/domains/cucumber/applications/app/events" with the following:"event=add-alias&alias=app-cucumber.example.com"
    Then the response should be "200"
    When I send a POST request to "/domains/cucumber/applications/app/events" with the following:"event=remove-alias&alias=app-cucumber.example.com"
    Then the response should be "200"
    When I send a DELETE request to "/domains/cucumber/applications/app"
    Then the response should be "204"
