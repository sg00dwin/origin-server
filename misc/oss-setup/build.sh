...
for i in 10gen-mms-agent-0.1 cron-1.4 diy-0.1 jbossas-7 jbosseap-6.0 jenkins-1.4 jenkins-client-1.4 mongodb-2.2 mysql-5.1 nodejs-0.6 perl-5.10 php-5.3 phpmyadmin-3.4 python-2.6 ruby-1.8 ; do 
