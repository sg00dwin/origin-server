...
then
  ...
  yum -y install ruby rubygems git tito java-devel jpackage-utils pam-devel libselinux-devel selinux-policy gcc-c++ rubygem-rake rubygem-rspec libxml2-devel libxslt-devel rubygem-bundler js
else
