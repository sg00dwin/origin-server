...
bundle exec rails runner "CloudUser.new(login: 'user_with_multiple_gear_sizes@test.com').save"
if [ $? -eq 0 ]
then
...
bundle exec rails runner "u=CloudUser.new(login: 'user_with_extra_storage@test.com'); u.capabilities['max_storage_per_gear'] = 10; u.save"
if [ $? -ne 0 ]
then
